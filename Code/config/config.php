 ...
 */
$conf['settings']['app.title'] = 'LIMU Scheduler';			// application title
...
$conf['settings']['admin.email'] = 'schedule@limu.edu.ly';         // email address of admin user
$conf['settings']['admin.email.name'] = 'LIMU Administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://localhost:8080';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['password'] = 'bookedscheduler';
$conf['settings']['database']['hostspec'] = 'database';        // ip, dns or named pipe
 ...
 */
$conf['settings']['install.password'] = '5a08c275e516c';
/**
 * Pages
 */
